export default {
  ...
  work: {
    fish: {
      ...
      start: {
        en: "The weather is {{weather}} at the {{location}}! Cast your line!",
        ru: "Погода {{weather}} в {{location}}! Закиньте удочку!",
        uk: "Погода {{weather}} в {{location}}! Закиньте вудку!",
      ...
      streak: {
        en: "Catch Streak",
        ru: "Серия удачных забросов",
        uk: "Серія вдалих закидань",
        ja: "連続釣り",
      },
      success: {
        en: "Fishing Complete!",
        ru: "Рыбалка завершена!",
        uk: "Риболовля завершена!",
        ja: "釣りが完了しました！",
      },
      reward: {
        en: "You earned {{amount}}¥ from fishing!",
        ru: "Вы заработали {{amount}}¥ на рыбалке!",
        uk: "Ви заробили {{amount}}¥ на риболовлі!",
        ja: "釣りで{{amount}}円を稼ぎました！",
      },
      timeout_title: {
        en: "Time's Up!",
        ru: "Время вышло!",
      ...
      timeout: {
        en: "You ran out of time to catch enough fish!",
        ru: "У вас закончилось время для ловли рыбы!",
        uk: "У вас закінчився час для лову риби!",
        ja: "魚を釣る時間が終わりました！",
      },
      weather: {
        sunny: {
      ...
      bonus: {
        ...
        golden: {
          en: "Golden Hour Bonus",
          ru: "Бонус золотого часа",
          uk: "Бонус золотої години",
          ja: "ゴールデンアワーボーナス",
        },
      },
    },
