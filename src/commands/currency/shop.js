...
export async function run({ interaction, client }) {
  ...
  if (error) {
    ...
    return interaction.editReply(client.getLocale(locale, "shop.error"));
  }

  if (!items || items.length === 0) {
    return interaction.editReply(client.getLocale(locale, "shop.empty"));
  }

  // Create the shop embed
  const embed = new EmbedBuilder()
    .setColor(client.embedColor)
    .setDescription(client.getLocale(locale, "shop.selectItemToBuy"));

  // Create the dropdown menu (single selection)
  const select = new StringSelectMenuBuilder()
    .setCustomId("shop_select")
    .setPlaceholder(client.getLocale(locale, "shop.selectPlaceholder"))
    .addOptions(
      items.map((item) =>
  ...
  const quantityRow = new ActionRowBuilder().addComponents(
    new ButtonBuilder()
      .setCustomId("buy_one")
      .setLabel(client.getLocale(locale, "shop.buyOne"))
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId("buy_five")
      .setLabel(client.getLocale(locale, "shop.buyFive"))
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId("buy_ten")
      .setLabel(client.getLocale(locale, "shop.buyTen"))
      .setStyle(ButtonStyle.Secondary),
    new ButtonBuilder()
      .setCustomId("buy_max")
      .setLabel(client.getLocale(locale, "shop.buyMax"))
  ...
  const actionRow = new ActionRowBuilder().addComponents(
    new ButtonBuilder()
      ...
      .setLabel(client.getLocale(locale, "shop.skipItem"))
      .setStyle(ButtonStyle.Secondary)
  );
    ...
    try {
      if (i.customId === "shop_select") {
        ...
        const quantityEmbed = new EmbedBuilder()
          ...
          .setDescription(
            client
              .getLocale(locale, "shop.selectQuantityPreset")
        ...
        const currentCount = await getCurrentInventoryCount(
          interaction.user.id
        );
        ...
        if (availableSlots <= 0) {
          const errorEmbed = new EmbedBuilder()
            .setColor(client.embedColor)
            .setDescription(client.getLocale(locale, "shop.inventoryFull"));
          ...
          const errorEmbed = new EmbedBuilder()
            ...
            .setDescription(
              error.message.includes("Insufficient balance")
                ? client.getLocale(locale, "shop.notEnoughBalance")
                : client.getLocale(locale, "shop.purchaseError")
            );
          await i.update({ embeds: [errorEmbed], components: [] });
        ...
        const successEmbed = new EmbedBuilder()
          ...
          .setDescription(
            client
              .getLocale(locale, "shop.itemPurchasedAskMore")
              .replace("{item}", currentItem.name)
        ...
        const continueRow = new ActionRowBuilder().addComponents(
          new ButtonBuilder()
            ...
            .setLabel(client.getLocale(locale, "shop.buyMore"))
            .setStyle(ButtonStyle.Success),
          new ButtonBuilder()
            .setCustomId("finish_shopping")
            .setLabel(client.getLocale(locale, "shop.finishShopping"))
            .setStyle(ButtonStyle.Secondary)
        );
        ...
        const finalEmbed = new EmbedBuilder()
          .setColor(client.embedColor)
          .setDescription(client.getLocale(locale, "shop.shoppingComplete"));
      ...
      try {
        const errorEmbed = new EmbedBuilder()
          .setColor(client.embedColor)
          .setDescription(client.getLocale(locale, "shop.error"));
    ...
    if (reason === "time") {
      try {
        const timeoutEmbed = new EmbedBuilder()
          .setColor(client.embedColor)
          .setDescription(client.getLocale(locale, "shop.timeout"));
